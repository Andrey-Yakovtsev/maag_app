...
from maag_app.domain.views import mcc_report_view, MccReportView
...
urlpatterns = [
    ...
    path("mcc-report-2/", mcc_report_view, name="mcc_report_2",),
    path("mcc-report-3/", MccReportView.as_view(), name="mcc_report_3",)
]
